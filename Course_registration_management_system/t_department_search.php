...
$sql1= "select DISTINCT designation from teacher WHERE department='$department' ORDER BY department ASC,designation ASC,code_name ASC";
...
while ($row1 = $result1-> fetch_assoc()){
	...
	?>
<br><br><br>
<h2 align="center"><u><B><?php echo strtoupper($row1['designation']); ?></b></u></h2>
<br>
...
<?php
$sql = "select t_name,code_name,gender,email,mobile,designation,department,image from teacher where department='$department' AND designation='$designation' ORDER BY code_name ASC";
