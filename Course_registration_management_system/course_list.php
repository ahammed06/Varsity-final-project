...
$sql1= "select DISTINCT department from course ORDER BY department ASC,course_code ASC";
...
$sql= "select course_title,course_code,pre_req,department,credit from course WHERE department='$department' ORDER BY department ASC,course_code ASC";
