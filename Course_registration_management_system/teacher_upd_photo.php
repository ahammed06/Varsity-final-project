...
$sql= "select id,t_name,gender,email,mobile,room,degisnation,department,image from teacher WHERE `id` = $id";
...
<div class="header" id="myHeader">
  ...
  <ul><b>
  <li><a href="teach_profile.php">Home</a></li>
...
?>
<form action="teacher_updated_image.php" method="POST" class="container" enctype="multipart/form-data">
<h3 align="center">UPDATE PROFILE PICTURE</h3>
<fieldset>
