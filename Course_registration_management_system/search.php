...
<div class="column" style="background-image:url('images/student.jpg'); background-position: center;
    ...
    position: relative;">
		...
		<br>
		<br>
		<h1>Search Student's Information</h1>
        </div>
  </div></a>
...
<div class="column" style="background-image:url('images/teacher.jpg'); background-position: center;
    ...
    position: relative;">
		...
		<br>
		<br>
		<h1>Search Teacher's Information</h1>
        </div>
  </div></a>
...
<div class="column" style="background-image:url('images/course.jpg'); background-position: center;
  ...
  <a href="search_offered_course.php">
<div class="column1" style="background-image:url('images/offered-course.jpg'); background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
    position: relative;">
        <div id="linkedinB" >
		...
		<br>
		<br>
		<h1>Search Offered Course</h1>
        </div>
  </div></a>
  
  <a href="search_incharge.php">
<div class="column2" style="background-image:url('images/incharge.jpg'); background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
    position: relative;">
        <div id="linkedinB" >
		...
		<br>
		<br>
		<h1>Search Intake Incharge</h1>
        </div>
  </div></a>
  
  <a href="search_routine.php">
<div class="column3" style="background-image:url('images/routine.jpg'); background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
    position: relative;">
        <div id="linkedinB" >
