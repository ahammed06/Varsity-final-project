...
$sql2= "select DISTINCT department from student WHERE department='$dep' AND department='$d' AND intake='$i' AND section='$s' ORDER BY department ASC,intake DESC,section ASC,student_id ASC";
...
<?php
$sql1= "select DISTINCT intake from student WHERE department='$department' AND department='$dep' AND department='$d' AND intake='$int' AND intake='$i' AND section='$s' ORDER BY department ASC,intake DESC,section ASC,student_id ASC";
...
<?php
$sql3= "select DISTINCT section from student WHERE department='$department' AND department='$dep' AND department='$d' AND intake='$intake' AND intake='$int' AND section='$sec' AND intake='$i' AND section='$s' ORDER BY department ASC,intake DESC,section ASC,student_id ASC";
...
$sql= "select student_id,name,gender,email,intake,section,mobile,department,image from student WHERE department='$department' AND department='$dep' AND department='$d' AND intake='$intake' AND intake='$int' AND intake='$i' AND section='$section' AND section='$sec' AND section='$s' ORDER BY department ASC,intake DESC,section ASC,student_id ASC";
