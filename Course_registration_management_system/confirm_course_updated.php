...
$sql2="SELECT * FROM receipt WHERE student_id='$id' AND receipt_no='$receipt' AND semester='$s_name' AND year='$year'";
...
echo "<script type='text/javascript'>alert('$message');</script>";
	header("refresh:0; url=confirm_course_detail.php?accept=$id&receipt=$receipt");
}
