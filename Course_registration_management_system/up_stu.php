...
while ($row = $result-> fetch_assoc()){
	...
	<?php
echo "<td>". $row["student_id"] ."</td><td>". $row["name"] ."</td><td>". $row["gender"] ."</td><td>". $row["email"] ."</td><td>". $row["intake"] ."</td><td>". $row["section"] ."</td><td>". $row["mobile"] ."</td><td>". $row["department"] ."</td>";
?>
<td><a href="up_stu_dlt.php" class="btn btn-danger">Delete</a></td>
<td><a href="up_stu_upd.php" class="btn btn-danger">Update</a></td>
</tr>
<?php
}
echo "</table>";
