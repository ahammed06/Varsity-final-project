...
//	$id = $_GET['profile'];
	$sql= "select t_name,code_name,gender,email,mobile,room,designation,department,image from teacher 
...
<h2 style="font-family:cambria math" align="center">Teacher Profile</h2>
<fieldset>
...
<label for="room">Room No.: </label><?php echo $row['room']; ?><br>  
